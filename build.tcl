...
#
# Generated by Vivado on Mon Jan 31 19:27:01 CET 2022
...
#
#    "./dart_dpu_static/dart_dpu_static.srcs/sources_1/bd/dart/dart.bd"
#
#*****************************************************************************************
...
set _xil_proj_name_ "dart_dpu_static"
...
set script_file "dart_dpu_static.tcl"
...
set_property -name "board_part_repo_paths" -value "[file normalize "~/.Xilinx/Vivado/2020.2/xhub/board_store/xilinx_board_store"]" -objects $obj
...
set_property -name "sim.ipstatic.compiled_library_dir" -value "/home/aamory/repos/xilinx/dpu1/dpu1.cache/compile_simlib/xsim/ip" -objects $obj
...
#if { $obj != {} } {
   # set_property "ip_repo_paths" "[file normalize "$origin_dir/../../../Vitis-AI-1.3.1/Vitis-AI/dsa/DPU-TRD/dpu_ip/DPUCZDX8G_v3_3_0"] [file normalize "$origin_dir/../../dart/pr_tool-fork/designs/min_zcu102/dart/Sources/ip_repo"]" $obj
#   set_property "ip_repo_paths" "[file normalize "~/Vitis-AI-1.3.1/Vitis-AI/dsa/DPU-TRD/dpu_ip/DPUCZDX8G_v3_3_0"] [file normalize "~/repos/dart/pr_tool-fork/designs/min_zcu102/dart/Sources/ip_repo"]" $obj
   # Rebuild user ip_repo's index before adding any source files
#   update_ip_catalog -rebuild
#}

# add the IPs used byn the block design
set_property  ip_repo_paths ./hw/ips [current_project]
# Rebuild user ip_repo's index before adding any source files
update_ip_catalog -rebuild

# build the block design file
source hw/bd/top.tcl

# Set 'sources_1' fileset object
set obj [get_filesets sources_1]
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/${_xil_proj_name_}/${_xil_proj_name_}.srcs/sources_1/bd/dart/dart.bd"]\
]
set imported_files [import_files -fileset sources_1 $files]

#call make_wrapper to create wrapper files
set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse dart.bd] -top]
add_files -norecurse -fileset sources_1 $wrapper_path

#if { [get_property IS_LOCKED [ get_files -norecurse dart.bd] ] == 1  } {
#  import_files -fileset sources_1 [file normalize "${origin_dir}/dart_dpu_static.gen/sources_1/bd/dart/hdl/dart_wrapper.v" ]
#} else {
#  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse dart.bd] -top]
#  add_files -norecurse -fileset sources_1 $wrapper_path
#}
...
set_property -name "top" -value "dart_wrapper" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "/home/aamory/repos/xilinx/dpu1/dpu1.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "/home/aamory/repos/xilinx/dpu1/dpu1.srcs/utils_1/imports/impl_1" -objects $obj
...
# do synthesis and export the DCP file for the static part
launch_runs synth_1 -jobs 20
wait_on_run synth_1
open_run synth_1 -name synth_1
write_checkpoint ${origin_dir}/dart_wrapper.dcp -force
