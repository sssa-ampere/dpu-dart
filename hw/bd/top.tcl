...
################################################################
# This is a generated script based on design: dart
#
...
# Hierarchical cell: dpu_hier
proc create_hier_cell_dpu_hier { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_dpu_hier() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 DPU0_M_AXI_DATA0

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 DPU0_M_AXI_DATA1

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 DPU0_M_AXI_INSTR
  ...
  set_property -dict [ list \
   ...
   CONFIG.DNNDK_PRINT { \
     ...
     DPU Cores:1;Arch \
     DPU:30;Enable timestamp \
     Data Width:32;M-AXI \
     HP Data \
     HP Data \
     ID Width:2;DSP \
     LeakyReLU + \
     Length:4;DSP48 Usage:High;Ultra-RAM \
     Maximal Cascade \
     Number of \
     Protocol:AXI4;S-AXI Data \
     ReLU6;Number of \
     SFM cores:0;S-AXI \
     Slice Count:690;Ultra-RAM \
     Type:ReLU + \
  ...
  connect_bd_intf_net -intf_net DPUCZDX8G_0_DPU0_M_AXI_DATA0 [get_bd_intf_pins DPU0_M_AXI_DATA0] [get_bd_intf_pins DPUCZDX8G_0/DPU0_M_AXI_DATA0]
  connect_bd_intf_net -intf_net DPUCZDX8G_0_DPU0_M_AXI_DATA1 [get_bd_intf_pins DPU0_M_AXI_DATA1] [get_bd_intf_pins DPUCZDX8G_0/DPU0_M_AXI_DATA1]
  connect_bd_intf_net -intf_net DPUCZDX8G_0_DPU0_M_AXI_INSTR [get_bd_intf_pins DPU0_M_AXI_INSTR] [get_bd_intf_pins DPUCZDX8G_0/DPU0_M_AXI_INSTR]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_LPD [get_bd_intf_pins S_AXI] [get_bd_intf_pins DPUCZDX8G_0/S_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_dpu [get_bd_pins clk_dpu] [get_bd_pins DPUCZDX8G_0/m_axi_dpu_aclk] [get_bd_pins clk_wiz_0/clk_dpu] [get_bd_pins gen_rst_clk/slowest_sync_clk]
  ...
  connect_bd_net -net gen_rst_reg_peripheral_aresetn [get_bd_pins resetn] [get_bd_pins DPUCZDX8G_0/s_axi_aresetn] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins gen_rst_clk/ext_reset_in] [get_bd_pins gen_rst_clk_dsp/ext_reset_in]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins dout] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins clk_in1] [get_bd_pins DPUCZDX8G_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1]
...
proc create_root_design { parentCell } {
  ...
  set acc_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:acc:1.0 acc_0 ]
  ...
  # Create instance: dpu_hier
  create_hier_cell_dpu_hier [current_bd_instance .] dpu_hier
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net DPUCZDX8G_0_DPU0_M_AXI_DATA0 [get_bd_intf_pins dpu_hier/DPU0_M_AXI_DATA0] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP0_FPD]
  connect_bd_intf_net -intf_net DPUCZDX8G_0_DPU0_M_AXI_DATA1 [get_bd_intf_pins dpu_hier/DPU0_M_AXI_DATA1] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP1_FPD]
  connect_bd_intf_net -intf_net DPUCZDX8G_0_DPU0_M_AXI_INSTR [get_bd_intf_pins dpu_hier/DPU0_M_AXI_INSTR] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_LPD]
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins pr_decoupler_1/s_acc_data]
  connect_bd_intf_net -intf_net acc_0_m_axi_mem_bus [get_bd_intf_pins acc_0/m_axi_mem_bus] [get_bd_intf_pins pr_decoupler_1/rp_acc_data]
  ...
  connect_bd_intf_net -intf_net pr_decoupler_0_rp_acc_ctrl [get_bd_intf_pins acc_0/s_axi_ctrl_bus] [get_bd_intf_pins pr_decoupler_0/rp_acc_ctrl]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins pr_decoupler_0/s_acc_ctrl] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins pr_decoupler_0/s_axi_reg] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins ps8_0_axi_periph/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_LPD [get_bd_intf_pins dpu_hier/S_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_LPD]

  # Create port connections
  connect_bd_net -net acc_0_interrupt [get_bd_pins acc_0/interrupt] [get_bd_pins pr_decoupler_1/rp_acc_interrupt_INTERRUPT]
  connect_bd_net -net clk_wiz_0_clk_dpu [get_bd_pins dpu_hier/clk_dpu] [get_bd_pins zynq_ultra_ps_e_0/saxi_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk]
  connect_bd_net -net dart_hier_dout_0 [get_bd_pins xlconcat_0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net gen_rst_reg_interconnect_aresetn [get_bd_pins gen_rst_reg/interconnect_aresetn] [get_bd_pins pr_decoupler_0/rp_rp_reset_RST]
  connect_bd_net -net gen_rst_reg_peripheral_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins dpu_hier/resetn] [get_bd_pins gen_rst_reg/peripheral_aresetn] [get_bd_pins pr_decoupler_0/s_axi_reg_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN]
  ...
  connect_bd_net -net pr_decoupler_0_s_rp_reset_RST [get_bd_pins acc_0/ap_rst_n] [get_bd_pins pr_decoupler_0/s_rp_reset_RST]
  connect_bd_net -net pr_decoupler_1_s_acc_interrupt_INTERRUPT [get_bd_pins pr_decoupler_1/s_acc_interrupt_INTERRUPT] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins dpu_hier/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq1]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins acc_0/ap_clk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins dpu_hier/clk_in1] [get_bd_pins gen_rst_reg/slowest_sync_clk] [get_bd_pins pr_decoupler_0/aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces acc_0/Data_m_axi_mem_bus] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces acc_0/Data_m_axi_mem_bus] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_QSPI] -force
  assign_bd_address -offset 0x80000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs dpu_hier/DPUCZDX8G_0/S_AXI/reg0] -force
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs acc_0/s_axi_ctrl_bus/Reg] -force
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs pr_decoupler_0/s_axi_reg/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces dpu_hier/DPUCZDX8G_0/DPU0_M_AXI_DATA0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces dpu_hier/DPUCZDX8G_0/DPU0_M_AXI_DATA0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces dpu_hier/DPUCZDX8G_0/DPU0_M_AXI_DATA0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces dpu_hier/DPUCZDX8G_0/DPU0_M_AXI_DATA1] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces dpu_hier/DPUCZDX8G_0/DPU0_M_AXI_DATA1] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces dpu_hier/DPUCZDX8G_0/DPU0_M_AXI_DATA1] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces dpu_hier/DPUCZDX8G_0/DPU0_M_AXI_INSTR] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP6/LPD_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces dpu_hier/DPUCZDX8G_0/DPU0_M_AXI_INSTR] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP6/LPD_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces dpu_hier/DPUCZDX8G_0/DPU0_M_AXI_INSTR] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP6/LPD_QSPI] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces acc_0/Data_m_axi_mem_bus] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_LPS_OCM]
